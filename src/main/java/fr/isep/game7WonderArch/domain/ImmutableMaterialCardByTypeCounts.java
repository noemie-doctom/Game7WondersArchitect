...
public class ImmutableMaterialCardByTypeCounts {
	...
	public static ImmutableMaterialCardByTypeCounts.Builder builder() {
		return new ImmutableMaterialCardByTypeCounts.Builder();
	}
	...
	protected ImmutableMaterialCardByTypeCounts(ImmutableMaterialCardByTypeCounts.Builder b) {
